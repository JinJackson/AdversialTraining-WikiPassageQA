...
#params:
#--do_train --bert_model  "D:\Dev\Data\models\roberta-base" --model_type "MatchModel" --train_file "data/wikipassageQA/train.tsv" --dev_file "data/wikipassageQA/dev.tsv" --test_file "data/wikipassageQA/test.tsv" --do_lower_case --learning_rate 2e-6 --gpu 0 --epochs 5 --batch_size 2 --accumulate 1 --max_length 100 --seed 1024 --save_dir "result/test"

'''
--do_train \
--bert_model  "D:\Dev\Data\models\roberta-base" \
...
from RobertaDataset import TrainData
